...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="add_user.php"><i class="icon-group icon-2x"></i> Add User</a>                                    </li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>MixMart Store</center></font>
<div id="mainmain">
...
<a href="add_user.php"><i class="icon-group icon-2x"></i><br> Add User</a>     
