...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			include('../connect.php');
				...
				$stmt = $db->prepare('SELECT SUM(qty) AS total_qty FROM products');
				$stmt->execute();
			...
			Total Rows of Products:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>&nbsp;&nbsp;&nbsp;-
			Total Number of Products (QTY):  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $sum_qty;?>]</font>
			</div>
			
			<div style="text-align:center;">
			<font style="color:rgb(255, 95, 66); font:bold 22px 'Aleo';">[<?php echo $rowcount123;?>]</font> Products are below QTY of 20 
			</div>
</div>
