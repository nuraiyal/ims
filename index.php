...
<body>
    <div class="container-fluid" style="text-align:center;">
		<img src="images/logo.png" alt="" style="width:200px; height:200px; border-radius:50%; margin:-10px 0; box-shadow: 1px 2px 3px black;">
      <div class="row-fluid">
		<div class="span4">
		</div>
...
<form action="login.php" method="post">
			...
			<font style=" font:bold 34px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>MixMart</center></font>
		<br>
